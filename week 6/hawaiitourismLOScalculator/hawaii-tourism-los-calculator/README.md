...
**Note:** I was unable to install and run MongoDB locally due to my macOS version being out of date. I attempted to install MongoDB using Homebrew, but my system required a software update that I could not complete in time. I also tried using MacPorts, but that method was unsuccessful as well. All code, data, and review steps are complete and ready for import and execution as soon as MongoDB is available (either via MacPorts, Homebrew, or MongoDB Atlas). See the code review and comments for details. For production deployment, I recommend using MongoDB Atlas or a supported local install.

## Updates (Spring 2026)

- 2/22/2026 Added code review, security improvements, and updated data import instructions per Individual Project III assignment.
- 2/22/2026 Documented vulnerabilities and fixes in the Code Review Template (see /week6/Code_Review_Template_Week5.md).
- 2/22/2026 Updated /standalone/data.csv to include data through 2025.
